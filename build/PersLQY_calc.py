...
int_Abs1 = FExc*np.sum(Abs_ref.counts[i_t0A_ref:i_t1A_ref+1])*ODc_abs # Abs ref integration
...
int_total = np.sum(Lum_Pers_c[i_t0:])
...
plt.savefig(initdir+"/measurement.png")
# plt.figure(5)
